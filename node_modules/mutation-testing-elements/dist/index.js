 ...
 */
const dt = globalThis, Jt = dt.ShadowRoot && (dt.ShadyCSS === void 0 || dt.ShadyCSS.nativeShadow) && "adoptedStyleSheets" in Document.prototype && "replace" in CSSStyleSheet.prototype, en = Symbol(), wr = /* @__PURE__ */ new WeakMap();
let Mi = class {
  constructor(t, r, n) {
...
const H = (e) => new Mi(typeof e == "string" ? e : e + "", void 0, en), Ti = (e, t) => {
  if (Jt) e.adoptedStyleSheets = t.map((r) => r instanceof CSSStyleSheet ? r : r.styleSheet);
  else for (const r of t) {
    const n = document.createElement("style"), i = dt.litNonce;
    i !== void 0 && n.setAttribute("nonce", i), n.textContent = r.cssText, e.appendChild(n);
  }
}, xr = Jt ? (e) => e : (e) => e instanceof CSSStyleSheet ? ((t) => {
  let r = "";
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const { is: Pi, defineProperty: Fi, getOwnPropertyDescriptor: zi, getOwnPropertyNames: Oi, getOwnPropertySymbols: ji, getPrototypeOf: Ri } = Object, St = globalThis, $r = St.trustedTypes, Bi = $r ? $r.emptyScript : "", Di = St.reactiveElementPolyfillSupport, Ie = (e, t) => e, mt = { toAttribute(e, t) {
  switch (t) {
    case Boolean:
      e = e ? Bi : null;
      break;
  ...
  return r;
} }, Qt = (e, t) => !Pi(e, t), kr = { attribute: !0, type: String, converter: mt, reflect: !1, hasChanged: Qt };
...
class Ae extends HTMLElement {
  ...
  static getPropertyDescriptor(t, r, n) {
    const { get: i, set: s } = zi(this.prototype, t) ?? { get() {
      return this[r];
    }, set(a) {
      this[r] = a;
    } };
    return { get() {
      ...
      const o = i?.call(this);
      s.call(this, a), this.requestUpdate(t, o, n);
  ...
  static finalize() {
    ...
    if (this.finalized = !0, this._$Ei(), this.hasOwnProperty(Ie("properties"))) {
      const r = this.properties, n = [...Oi(r), ...ji(r)];
  ...
  static finalizeStyles(t) {
    ...
    if (Array.isArray(t)) {
      ...
      for (const i of n) r.unshift(xr(i));
    } else t !== void 0 && r.push(xr(t));
    return r;
  }
  static _$Eu(t, r) {
    const n = r.attribute;
  ...
  _$EC(t, r) {
    ...
    if (i !== void 0 && n.reflect === !0) {
      const s = (n.converter?.toAttribute !== void 0 ? n.converter : mt).toAttribute(r, n.type);
  ...
  _$AK(t, r) {
    ...
    if (i !== void 0 && this._$Em !== i) {
      const s = n.getPropertyOptions(i), a = typeof s.converter == "function" ? { fromAttribute: s.converter } : s.converter?.fromAttribute !== void 0 ? s.converter : mt;
      this._$Em = i, this[i] = a.fromAttribute(r, s.type), this._$Em = null;
    }
  }
  requestUpdate(t, r, n) {
    if (t !== void 0) {
      if (n ??= this.constructor.getPropertyOptions(t), !(n.hasChanged ?? Qt)(this[t], r)) return;
      this.P(t, r, n);
    }
...
Ae.elementStyles = [], Ae.shadowRootOptions = { mode: "open" }, Ae[Ie("elementProperties")] = /* @__PURE__ */ new Map(), Ae[Ie("finalized")] = /* @__PURE__ */ new Map(), Di?.({ ReactiveElement: Ae }), (St.reactiveElementVersions ??= []).push("2.0.4");
/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */
const Xt = globalThis, vt = Xt.trustedTypes, _r = vt ? vt.createPolicy("lit-html", { createHTML: (e) => e }) : void 0, er = "$lit$", te = `lit$${Math.random().toFixed(9).slice(2)}$`, tr = "?" + te, Ii = `<${tr}>`, me = document, Ue = () => me.createComment(""), He = (e) => e === null || typeof e != "object" && typeof e != "function", rr = Array.isArray, tn = (e) => rr(e) || typeof e?.[Symbol.iterator] == "function", Ft = `[ 	
\f\r]`, Re = /<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g, Ar = /-->/g, Sr = />/g, de = RegExp(`>|${Ft}(?:([^\\s"'>=/]+)(${Ft}*=${Ft}*(?:[^ 	
\f\r"'\`<>=]|("|')|))|$)`, "g"), Cr = /'/g, Er = /"/g, rn = /^(?:script|style|textarea|title)$/i, nn = (e) => (t, ...r) => ({ _$litType$: e, strings: t, values: r }), m = nn(1), R = nn(2), Q = Symbol.for("lit-noChange"), $ = Symbol.for("lit-nothing"), Mr = /* @__PURE__ */ new WeakMap(), fe = me.createTreeWalker(me, 129);
function sn(e, t) {
...
const an = (e, t) => {
  ...
  let i, s = t === 2 ? "<svg>" : t === 3 ? "<math>" : "", a = Re;
  for (let o = 0; o < r; o++) {
    const l = e[o];
    let c, b, g = -1, v = 0;
    for (; v < l.length && (a.lastIndex = v, b = a.exec(l), b !== null); ) v = a.lastIndex, a === Re ? b[1] === "!--" ? a = Ar : b[1] !== void 0 ? a = Sr : b[2] !== void 0 ? (rn.test(b[2]) && (i = RegExp("</" + b[2], "g")), a = de) : b[3] !== void 0 && (a = de) : a === de ? b[0] === ">" ? (a = i ?? Re, g = -1) : b[1] === void 0 ? g = -2 : (g = a.lastIndex - b[2].length, c = b[1], a = b[3] === void 0 ? de : b[3] === '"' ? Er : Cr) : a === Er || a === Cr ? a = de : a === Ar || a === Sr ? a = Re : (a = de, i = void 0);
    const y = a === de && e[o + 1].startsWith("/>") ? " " : "";
    s += a === Re ? l + Ii : g >= 0 ? (n.push(c), l.slice(0, g) + er + l.slice(g) + te + y) : l + te + (g === -2 ? o : y);
  }
  return [sn(e, s + (e[r] || "<?>") + (t === 2 ? "</svg>" : t === 3 ? "</math>" : "")), n];
};
class Ke {
  constructor({ strings: t, _$litType$: r }, n) {
    ...
    this.parts = [];
    let s = 0, a = 0;
    const o = t.length - 1, l = this.parts, [c, b] = an(t, r);
    if (this.el = Ke.createElement(c, n), fe.currentNode = this.el.content, r === 2 || r === 3) {
      const g = this.el.content.firstChild;
      g.replaceWith(...g.childNodes);
    }
    for (; (i = fe.nextNode()) !== null && l.length < o; ) {
      if (i.nodeType === 1) {
        if (i.hasAttributes()) for (const g of i.getAttributeNames()) if (g.endsWith(er)) {
          const v = b[a++], y = i.getAttribute(g).split(te), k = /([.?@])?(.*)/.exec(v);
          l.push({ type: 1, index: s, name: k[2], strings: y, ctor: k[1] === "." ? cn : k[1] === "?" ? un : k[1] === "@" ? dn : Xe }), i.removeAttribute(g);
        } else g.startsWith(te) && (l.push({ type: 6, index: s }), i.removeAttribute(g));
        if (rn.test(i.tagName)) {
          const g = i.textContent.split(te), v = g.length - 1;
          if (v > 0) {
            i.textContent = vt ? vt.emptyScript : "";
            for (let y = 0; y < v; y++) i.append(g[y], Ue()), fe.nextNode(), l.push({ type: 2, index: ++s });
            i.append(g[v], Ue());
          }
        }
        ...
        let g = -1;
        for (; (g = i.data.indexOf(te, g + 1)) !== -1; ) l.push({ type: 7, index: s }), g += te.length - 1;
      }
      s++;
    }
  }
...
function ve(e, t, r = e, n) {
  if (t === Q) return t;
  let i = n !== void 0 ? r.o?.[n] : r.l;
  const s = He(t) ? void 0 : t._$litDirective$;
  return i?.constructor !== s && (i?._$AO?.(!1), s === void 0 ? i = void 0 : (i = new s(e), i._$AT(e, r, n)), n !== void 0 ? (r.o ??= [])[n] = i : r.l = i), i !== void 0 && (t = ve(e, i._$AS(e, t.values), i, n)), t;
}
class on {
  constructor(t, r) {
  ...
  u(t) {
    ...
    fe.currentNode = i;
    let s = fe.nextNode(), a = 0, o = 0, l = n[0];
    for (; l !== void 0; ) {
      if (a === l.index) {
        let c;
        l.type === 2 ? c = new Ct(s, s.nextSibling, this, t) : l.type === 1 ? c = new l.ctor(s, l.name, l.strings, this, t) : l.type === 6 && (c = new hn(s, this, t)), this._$AV.push(c), l = n[++o];
      }
      a !== l?.index && (s = fe.nextNode(), a++);
    }
    return fe.currentNode = me, i;
  }
  p(t) {
    let r = 0;
...
let Ct = class ln {
  ...
  constructor(t, r, n, i) {
    this.type = 2, this._$AH = $, this._$AN = void 0, this._$AA = t, this._$AB = r, this._$AM = n, this.options = i, this.v = i?.isConnected ?? !0;
  }
  get parentNode() {
  ...
  _$AI(t, r = this) {
    t = ve(this, t, r), He(t) ? t === $ || t == null || t === "" ? (this._$AH !== $ && this._$AR(), this._$AH = $) : t !== this._$AH && t !== Q && this._(t) : t._$litType$ !== void 0 ? this.$(t) : t.nodeType !== void 0 ? this.T(t) : tn(t) ? this.k(t) : this._(t);
  }
  O(t) {
  ...
  _(t) {
    this._$AH !== $ && He(this._$AH) ? this._$AA.nextSibling.data = t : this.T(me.createTextNode(t)), this._$AH = t;
  }
  $(t) {
    const { values: r, _$litType$: n } = t, i = typeof n == "number" ? this._$AC(t) : (n.el === void 0 && (n.el = Ke.createElement(sn(n.h, n.h[0]), this.options)), n);
    if (this._$AH?._$AD === i) this._$AH.p(r);
    else {
      const s = new on(i, this), a = s.u(this.options);
      s.p(r), this.T(a), this._$AH = s;
    }
  }
  _$AC(t) {
    let r = Mr.get(t.strings);
    return r === void 0 && Mr.set(t.strings, r = new Ke(t)), r;
  }
  k(t) {
    rr(this._$AH) || (this._$AH = [], this._$AR());
    const r = this._$AH;
    let n, i = 0;
    for (const s of t) i === r.length ? r.push(n = new ln(this.O(Ue()), this.O(Ue()), this, this.options)) : n = r[i], n._$AI(s), i++;
...
class Xe {
  ...
  _$AI(t, r = this, n, i) {
    ...
    let a = !1;
    if (s === void 0) t = ve(this, t, r, 0), a = !He(t) || t !== this._$AH && t !== Q, a && (this._$AH = t);
    else {
      const o = t;
      let l, c;
      for (t = s[0], l = 0; l < s.length - 1; l++) c = ve(this, o[n + l], r, l), c === Q && (c = this._$AH[l]), a ||= !He(c) || c !== this._$AH[l], c === $ ? t = $ : t !== $ && (t += (c ?? "") + s[l + 1]), this._$AH[l] = c;
    }
    a && !i && this.j(t);
  }
  j(t) {
...
const Li = { M: er, P: te, A: tr, C: 1, L: an, R: on, D: tn, V: ve, I: Ct, H: Xe, N: un, U: dn, B: cn, F: hn }, Ni = Xt.litHtmlPolyfillSupport;
Ni?.(Ke, Ct), (Xt.litHtmlVersions ??= []).push("3.2.0");
const Ui = (e, t, r) => {
  const n = r?.renderBefore ?? t;
  let i = n._$litPart$;
  if (i === void 0) {
    const s = r?.renderBefore ?? null;
    n._$litPart$ = i = new Ct(t.insertBefore(Ue(), s), s, void 0, r ?? {});
  }
  return i._$AI(e), i;
};
/**
...
let Z = class extends Ae {
  ...
  update(t) {
    const r = this.render();
    this.hasUpdated || (this.renderOptions.isConnected = this.isConnected), super.update(t), this.o = Ui(r, this.renderRoot, this.renderOptions);
  }
  connectedCallback() {
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const Ki = { attribute: !0, type: String, converter: mt, reflect: !1, hasChanged: Qt }, Vi = (e = Ki, t, r) => {
  ...
  if (s === void 0 && globalThis.litPropertyMetadata.set(i, s = /* @__PURE__ */ new Map()), s.set(r.name, e), n === "accessor") {
    ...
    return { set(o) {
      ...
      t.set.call(this, o), this.requestUpdate(a, l, e);
    }, init(o) {
      return o !== void 0 && this.P(a, void 0, e), o;
    } };
  }
  if (n === "setter") {
    const { name: a } = r;
    return function(o) {
      const l = this[a];
      t.call(this, o), this.requestUpdate(a, l, e);
    };
  }
  throw Error("Unsupported decorator location: " + n);
};
function A(e) {
  return (t, r) => typeof r == "object" ? Vi(e, t, r) : ((n, i, s) => {
...
function qi(e, t) {
  return e.reduce((r, n) => {
    const i = t(n);
    return Object.prototype.hasOwnProperty.call(r, i) || (r[i] = []), r[i].push(n), r;
  }, {});
}
const Zi = "/";
function Tr(e, t, r) {
  const n = Object.keys(e), i = Wi(n), s = /* @__PURE__ */ Object.create(null);
  return n.forEach((a) => {
    const o = Pr(a.startsWith(t) ? a.substr(t.length) : a);
    s[Pr(a.substr(i.length))] = r(e[a], o);
  }), s;
}
function Pr(e) {
...
function Gi(e) {
  return e === J.lineFeed || e === J.carriageReturn || e === J.lineSeparator || e === J.paragraphSeparator;
}
function Ji(e) {
  const t = [];
  let r = 0, n = 0;
  ...
  for (i(0); r < e.length; ) {
    ...
    switch (r++, s) {
      case J.carriageReturn:
        e.charCodeAt(r) === J.lineFeed && r++, i(r);
        break;
      case J.lineFeed:
        i(r);
        break;
      default:
        s > J.maxAsciiCharacter && Gi(s) && i(r);
        break;
    }
  }
  return t.push(n), t;
...
class Qi {
   ...
   */
  getMutatedLines() {
    return zt(this.sourceFile), this.sourceFile.getMutationLines(this);
  }
  /**
   * Retrieves the original source lines for this mutant, to be shown in a diff view.
   */
  getOriginalLines() {
    return zt(this.sourceFile), this.sourceFile.getLines(this.location);
  }
  /**
   ...
   */
  get fileName() {
    return zt(this.sourceFile), this.sourceFile.name;
  }
...
class pn {
  lineMap;
  getLineMap() {
    return Fr(this.source), this.lineMap ?? (this.lineMap = Ji(this.source));
  }
  /**
...
class Xi extends pn {
   ...
   */
  constructor(t, r) {
    super(), this.name = r, this.language = t.language, this.source = t.source, this.mutants = t.mutants.map((n) => {
      const i = new Qi(n);
   ...
   */
  getMutationLines(t) {
    const r = this.getLineMap(), n = r[t.location.start.line], i = r[t.location.end.line], s = r[t.location.end.line + 1];
    return `${this.source.substr(n, t.location.start.column - 1)}${t.replacement ?? t.description ?? t.mutatorName}${this.source.substring(i + t.location.end.column - 1, s)}`;
  }
}
class fn {
  /**
  ...
  metrics;
  constructor(t, r, n, i) {
    this.name = t, this.childResults = r, this.metrics = n, this.file = i;
  }
  updateParent(t) {
  ...
  updateMetrics() {
    if (this.file === void 0) {
      ...
      if (t.length === 0)
        return;
      t[0].tests ? this.metrics = Ut(t) : this.metrics = bt(t);
      return;
    }
    this.file.tests ? this.metrics = Ut([this.file]) : this.metrics = bt([this.file]);
  }
  #e(t) {
    const r = [];
...
class ts {
   ...
   */
  getLines() {
    return zr(this.sourceFile), es(this.location), this.sourceFile.getLines(this.location);
  }
  /**
   * Helper property to retrieve the source file name
   * @throws When the `sourceFile` is not defined.
  ...
  get status() {
    return this.#e.size ? j.Killing : this.#t.size ? j.Covering : j.NotCovering;
  }
  update() {
    this.sourceFile?.result?.file && this.sourceFile.result.updateAllMetrics();
  }
...
class rs extends pn {
   ...
   */
  constructor(t, r) {
    super(), this.name = r, this.source = t.source, this.tests = t.tests.map((n) => {
      const i = new ts(n);
      return i.sourceFile = this, i;
    });
  }
}
const Or = NaN, jr = "All files", ns = "All tests";
function is(e) {
  const { files: t, testFiles: r, projectRoot: n = "" } = e, i = Tr(t, n, (s, a) => new Xi(s, a));
  if (r && Object.keys(r).length) {
    const s = Tr(r, n, (a, o) => new rs(a, o));
    return as(Object.values(i).flatMap((a) => a.mutants), Object.values(s).flatMap((a) => a.tests)), {
      systemUnderTestMetrics: Ot(jr, i, bt),
      testMetrics: Ot(ns, s, Ut)
    };
  }
  return {
    systemUnderTestMetrics: Ot(jr, i, bt),
...
function Ot(e, t, r) {
  ...
  return n.length === 1 && n[0] === "" ? mn(e, t[n[0]], r) : gn(e, t, r);
}
function gn(e, t, r) {
  const n = r(Object.values(t)), i = ss(t, r);
  return new fn(e, i, n);
}
function mn(e, t, r) {
  return new fn(e, [], r([t]), t);
}
function ss(e, t) {
  const r = qi(Object.entries(e), (n) => n[0].split("/")[0]);
  return Object.keys(r).map((n) => {
    if (r[n].length > 1 || r[n][0][0] !== n) {
      const i = {};
      return r[n].forEach((s) => i[s[0].substr(n.length + 1)] = s[1]), gn(n, i, t);
    } else {
      const [i, s] = r[n][0];
      return mn(i, s, t);
    }
...
function Ut(e) {
  const t = e.flatMap((n) => n.tests), r = (n) => t.filter((i) => i.status === n).length;
  return {
    total: t.length,
    killing: r(j.Killing),
    covering: r(j.Covering),
    notCovering: r(j.NotCovering)
  };
}
function bt(e) {
  const t = e.flatMap((P) => P.mutants), r = (P) => t.filter((O) => O.status === P).length, n = r("Pending"), i = r("Killed"), s = r("Timeout"), a = r("Survived"), o = r("NoCoverage"), l = r("RuntimeError"), c = r("CompileError"), b = r("Ignored"), g = s + i, v = a + o, y = g + a, k = v + g, _ = l + c;
  return {
    pending: n,
    killed: i,
    timeout: s,
...
(function(e) {
  ...
  var r = function(n) {
    var i = /(?:^|\s)lang(?:uage)?-([\w-]+)(?=\s|$)/i, s = 0, a = {}, o = {
      ...
      util: {
        encode: function h(d) {
          return d instanceof l ? new l(d.type, h(d.content), d.alias) : Array.isArray(d) ? d.map(h) : d.replace(/&/g, "&amp;").replace(/</g, "&lt;").replace(/\u00a0/g, " ");
        },
        /**
         ...
         */
        objId: function(h) {
          return h.__id || Object.defineProperty(h, "__id", { value: ++s }), h.__id;
        },
        /**
         ...
         * @template T
         */
        clone: function h(d, f) {
          f = f || {};
          var u, p;
          switch (o.util.type(d)) {
            case "Object":
              if (p = o.util.objId(d), f[p])
                return f[p];
              u = /** @type {Record<string, any>} */
              {}, f[p] = u;
              for (var w in d)
                d.hasOwnProperty(w) && (u[w] = h(d[w], f));
              return (
                /** @type {any} */
                u
              );
            case "Array":
              return p = o.util.objId(d), f[p] ? f[p] : (u = [], f[p] = u, /** @type {Array} */
              /** @type {any} */
              d.forEach(function(S, x) {
                u[x] = h(S, f);
              }), /** @type {any} */
              u);
            default:
         ...
         * @returns {void}
         */
        setLanguage: function(h, d) {
          h.className = h.className.replace(RegExp(i, "gi"), ""), h.classList.add("language-" + d);
        },
        /**
        ...
        insertBefore: function(h, d, f, u) {
          ...
          for (var S in p)
            if (p.hasOwnProperty(S)) {
              if (S == d)
                for (var x in f)
                  f.hasOwnProperty(x) && (w[x] = f[x]);
              f.hasOwnProperty(S) || (w[S] = p[S]);
            }
          var T = u[h];
          return u[h] = w, o.languages.DFS(o.languages, function(F, Y) {
            Y === T && F != h && (this[F] = w);
          }), w;
        },
        // Traverse a language definition with Depth First Search
        DFS: function h(d, f, u, p) {
          p = p || {};
          var w = o.util.objId;
          for (var S in d)
            if (d.hasOwnProperty(S)) {
              f.call(d, S, d[S], u || S);
              var x = d[S], T = o.util.type(x);
              T === "Object" && !p[w(x)] ? (p[w(x)] = !0, h(x, f, null, p)) : T === "Array" && !p[w(x)] && (p[w(x)] = !0, h(x, f, S, p));
            }
        }
      },
      plugins: {},
       ...
       * @public
       */
      highlightAll: function(h, d) {
        o.highlightAllUnder(document, h, d);
      },
      /**
       ...
       * @public
       */
      highlightAllUnder: function(h, d, f) {
        var u = {
          callback: f,
          container: h,
       ...
       * @public
       */
      highlightElement: function(h, d, f) {
        var u = o.util.getLanguage(h), p = o.languages[u];
        o.util.setLanguage(h, u);
        var w = h.parentElement;
        w && w.nodeName.toLowerCase() === "pre" && o.util.setLanguage(w, u);
        var S = h.textContent, x = {
          element: h,
          language: u,
          grammar: p,
          code: S
        ...
        function T(Y) {
          x.highlightedCode = Y, o.hooks.run("before-insert", x), x.element.innerHTML = x.highlightedCode, o.hooks.run("after-highlight", x), o.hooks.run("complete", x), f && f.call(x.element);
        }
        if (o.hooks.run("before-sanity-check", x), w = x.element.parentElement, w && w.nodeName.toLowerCase() === "pre" && !w.hasAttribute("tabindex") && w.setAttribute("tabindex", "0"), !x.code) {
          o.hooks.run("complete", x), f && f.call(x.element);
          return;
        }
        if (o.hooks.run("before-highlight", x), !x.grammar) {
          T(o.util.encode(x.code));
          return;
        }
        if (d && n.Worker) {
          ...
          T(o.highlight(x.code, x.grammar, x.language));
      },
      /**
      ...
      highlight: function(h, d, f) {
        ...
        return u.tokens = o.tokenize(u.code, u.grammar), o.hooks.run("after-tokenize", u), l.stringify(o.util.encode(u.tokens), u.language);
      },
      /**
      ...
      tokenize: function(h, d) {
        ...
        var p = new g();
        return v(p, p.head, h), b(h, p, d, p.head, 0), k(p);
      },
      /**
       * @namespace
       * @memberof Prism
    ...
    n.Prism = o;
    function l(h, d, f, u) {
      this.type = h, this.content = d, this.alias = f, this.length = (u || "").length | 0;
    }
    l.stringify = function h(d, f) {
      if (typeof d == "string")
        return d;
      if (Array.isArray(d)) {
        var u = "";
      ...
      var p = {
        type: d.type,
        content: h(d.content, f),
        tag: "span",
        classes: ["token", d.type],
        attributes: {},
        language: f
      }, w = d.alias;
      w && (Array.isArray(w) ? Array.prototype.push.apply(p.classes, w) : p.classes.push(w)), o.hooks.run("wrap", p);
      var S = "";
      for (var x in p.attributes)
        S += " " + x + '="' + (p.attributes[x] || "").replace(/"/g, "&quot;") + '"';
      return "<" + p.tag + ' class="' + p.classes.join(" ") + '"' + S + ">" + p.content + "</" + p.tag + ">";
    };
    function c(h, d, f, u) {
      h.lastIndex = d;
      var p = h.exec(f);
      if (p && u && p[1]) {
        var w = p[1].length;
        p.index += w, p[0] = p[0].slice(w);
      }
      return p;
    }
    function b(h, d, f, u, p, w) {
      for (var S in f)
        if (!(!f.hasOwnProperty(S) || !f[S])) {
          ...
          for (var T = 0; T < x.length; ++T) {
            if (w && w.cause == S + "," + T)
              return;
            var F = x[T], Y = F.inside, _e = !!F.lookbehind, ze = !!F.greedy, st = F.alias;
            if (ze && !F.pattern.global) {
              var at = F.pattern.toString().match(/[imsuy]*$/)[0];
              F.pattern = RegExp(F.pattern.source, at + "g");
            }
            for (var Oe = F.pattern || F, z = u.next, M = p; z !== d.tail && !(w && M >= w.reach); M += z.value.length, z = z.next) {
              var D = z.value;
              ...
              if (!(D instanceof l)) {
                var ee = 1, U;
                if (ze) {
                  if (U = c(Oe, M, h, _e), !U || U.index >= h.length)
                    break;
                  var ot = U.index, Ci = U.index + U[0].length, oe = M;
                  for (oe += z.value.length; ot >= oe; )
                    z = z.next, oe += z.value.length;
                  if (oe -= z.value.length, M = oe, z.value instanceof l)
                    continue;
                  for (var je = z; je !== d.tail && (oe < Ci || typeof je.value == "string"); je = je.next)
                    ee++, oe += je.value.length;
                  ee--, D = h.slice(M, oe), U.index -= M;
                } else if (U = c(Oe, 0, D, _e), !U)
                  continue;
                var ot = U.index, lt = U[0], Mt = D.slice(0, ot), yr = D.slice(ot + lt.length), Tt = M + D.length;
                w && Tt > w.reach && (w.reach = Tt);
                var ct = z.prev;
                Mt && (ct = v(d, ct, Mt), M += Mt.length), y(d, ct, ee);
                var Ei = new l(S, Y ? o.tokenize(lt, Y) : lt, st, lt);
                if (z = v(d, ct, Ei), yr && v(d, z, yr), ee > 1) {
                  var Pt = {
                    cause: S + "," + T,
                    reach: Tt
                  };
                  b(h, d, f, z.prev, M, Pt), w && Pt.reach > w.reach && (w.reach = Pt.reach);
                }
              }
            }
          }
    ...
    function g() {
      var h = { value: null, prev: null, next: null }, d = { value: null, prev: h, next: null };
      h.next = d, this.head = h, this.tail = d, this.length = 0;
    }
    function v(h, d, f) {
      var u = d.next, p = { value: f, prev: d, next: u };
      return d.next = p, u.prev = p, h.length++, p;
    }
    function y(h, d, f) {
      for (var u = d.next, p = 0; p < f && u !== h.tail; p++)
        u = u.next;
      d.next = u, u.prev = d, h.length -= p;
    }
    function k(h) {
    ...
    if (!n.document)
      return n.addEventListener && (o.disableWorkerMessageHandler || n.addEventListener("message", function(h) {
        var d = JSON.parse(h.data), f = d.language, u = d.code, p = d.immediateClose;
        n.postMessage(o.highlight(u, o.languages[f], f)), p && n.close();
      }, !1)), o;
  ...
  e.exports && (e.exports = r), typeof Rr < "u" && (Rr.Prism = r);
})(vn);
var Br = vn.exports;
...
(function(e) {
  function t(M, D) {
    return M.replace(/<<(\d+)>>/g, function(ee, U) {
      return "(?:" + D[+U] + ")";
    });
  }
  function r(M, D, ee) {
  ...
  e.languages.csharp = e.languages.extend("clike", {
    ...
    "class-name": [
      ...
      },
      {
        ...
        pattern: r(/(\busing\s+<<0>>\s*=\s*)<<1>>(?=\s*;)/.source, [v, d]),
        lookbehind: !0,
        inside: f
      },
      {
      ...
      },
      {
        ...
        pattern: r(/(\b(?:is(?:\s+not)?|as)\s+)<<0>>/.source, [P]),
        lookbehind: !0,
        inside: f
      },
      {
        ...
        pattern: r(/\b<<0>>(?=\s+(?!<<1>>|with\s*\{)<<2>>(?:\s*[=,;:{)\]]|\s+(?:in|when)\b))/.source, [d, c, v]),
        inside: f
      }
    ],
    keyword: o,
    ...
    "return-type": {
      ...
      pattern: r(/<<0>>(?=\s+(?:<<1>>\s*(?:=>|[({]|\.\s*this\s*\[)|this\s*\[))/.source, [d, k]),
      inside: f,
      alias: "class-name"
    },
    ...
    "type-list": {
      ...
      pattern: r(
        ...
        [a, y, v, d, o.source, g, /\bnew\s*\(\s*\)/.source]
      ),
      lookbehind: !0,
      inside: {
        "record-arguments": {
          pattern: r(/(^(?!new\s*\()<<0>>\s*)<<1>>/.source, [y, g]),
          lookbehind: !0,
          greedy: !0,
  ...
  var S = p + "|" + u, x = t(/\/(?![*/])|\/\/[^\r\n]*[\r\n]|\/\*(?:[^*]|\*(?!\/))*\*\/|<<0>>/.source, [S]), T = n(t(/[^"'/()]|<<0>>|\(<<self>>*\)/.source, [x]), 2), F = /\b(?:assembly|event|field|method|module|param|property|return|type)\b/.source, Y = t(/<<0>>(?:\s*\(<<1>>*\))?/.source, [k, T]);
  e.languages.insertBefore("csharp", "class-name", {
    attribute: {
      // Attributes
      // [Foo], [Foo(1), Bar(2, Prop = "foo")], [return: Foo(1), Bar(2)], [assembly: Foo(Bar)]
      pattern: r(/((?:^|[^\s\w>)?])\s*\[\s*)(?:<<0>>\s*:\s*)?<<1>>(?:\s*,\s*<<1>>)*(?=\s*\])/.source, [F, Y]),
      lookbehind: !0,
      greedy: !0,
      inside: {
        target: {
          pattern: r(/^<<0>>(?=\s*:)/.source, [F]),
          alias: "keyword"
        },
        "attribute-arguments": {
  ...
  var _e = /:[^}\r\n]+/.source, ze = n(t(/[^"'/()]|<<0>>|\(<<self>>*\)/.source, [x]), 2), st = t(/\{(?!\{)(?:(?![}:])<<0>>)*<<1>>?\}/.source, [ze, _e]), at = n(t(/[^"'/()]|\/(?!\*)|\/\*(?:[^*]|\*(?!\/))*\*\/|<<0>>|\(<<self>>*\)/.source, [S]), 2), Oe = t(/\{(?!\{)(?:(?![}:])<<0>>)*<<1>>?\}/.source, [at, _e]);
  function z(M, D) {
    return {
      interpolation: {
        pattern: r(/((?:^|[^{])(?:\{\{)*)<<0>>/.source, [M]),
        lookbehind: !0,
        inside: {
          "format-string": {
            pattern: r(/(^\{(?:(?![}:])<<0>>)*)<<1>>(?=\}$)/.source, [D, _e]),
            lookbehind: !0,
            inside: {
              punctuation: /^:/
            }
  ...
  e.languages.insertBefore("csharp", "string", {
    "interpolation-string": [
      {
        pattern: r(/(^|[^\\])(?:\$@|@\$)"(?:""|\\[\s\S]|\{\{|<<0>>|[^\\{"])*"/.source, [st]),
        lookbehind: !0,
        greedy: !0,
        inside: z(st, ze)
      },
      {
        pattern: r(/(^|[^@\\])\$"(?:\\.|\{\{|<<0>>|[^\\"{])*"/.source, [Oe]),
        lookbehind: !0,
        greedy: !0,
        inside: z(Oe, at)
      }
        ...
        if (r.language === n) {
          ...
          r.code = r.code.replace(i, function(o) {
            if (typeof s == "function" && !s(o))
              return o;
            for (var l = a.length, c; r.code.indexOf(c = t(n, l)) !== -1; )
              ++l;
            return a[l] = o, c;
        ...
        function a(o) {
          for (var l = 0; l < o.length && !(i >= s.length); l++) {
            ...
            if (typeof c == "string" || c.content && typeof c.content == "string") {
              var b = s[i], g = r.tokenStack[b], v = typeof c == "string" ? c : c.content, y = t(n, b), k = v.indexOf(y);
              if (k > -1) {
                ++i;
                var _ = v.substring(0, k), P = new e.Token(n, e.tokenize(g, r.grammar), "language-" + n, g), O = v.substring(k + y.length), h = [];
                _ && h.push.apply(h, a([_])), h.push(P), O && h.push.apply(h, a([O])), typeof c == "string" ? o.splice.apply(o, [l, 1].concat(h)) : c.content = h;
              }
...
(function(e) {
  ...
  e.languages.insertBefore("php", "variable", {
    ...
    if (/<\?/.test(l.code)) {
      var c = /<\?(?:[^"'/#]|\/(?![*/])|("|')(?:\\[\s\S]|(?!\1)[^\\])*\1|(?:\/\/|#(?!\[))(?:[^?\n\r]|\?(?!>))*(?=$|\?>|[\r\n])|#\[|\/\*(?:[^*]|\*(?!\/))*(?:\*\/|$))*?(?:\?>|$)/g;
      e.languages["markup-templating"].buildPlaceholders(l, "php", c);
    }
  }), e.hooks.add("after-tokenize", function(l) {
    e.languages["markup-templating"].tokenizePlaceholders(l, "php");
  });
})(Prism);
const Dr = "(if|else if|await|then|catch|each|html|debug)";
...
(function() {
  typeof Prism > "u" || typeof document > "u" || !document.createRange || (Prism.plugins.KeepMarkup = !0, Prism.hooks.add("before-highlight", function(e) {
    ...
    function s(o) {
      ...
      i.push(l), a(o), l.posClose = n;
    }
    function a(o) {
      for (var l = 0, c = o.childNodes.length; l < c; l++) {
        var b = o.childNodes[l];
        b.nodeType === 1 ? s(b) : b.nodeType === 3 && (n += b.data.length);
      }
    }
    a(e.element), i.length && (e.keepMarkup = i);
  }), Prism.hooks.add("after-highlight", function(e) {
    if (e.keepMarkup && e.keepMarkup.length) {
      var t = function(r, n) {
        for (var i = 0, s = r.childNodes.length; i < s; i++) {
...
function ds(e, t, r, n) {
  ...
  return new (r || (r = Promise))(function(s, a) {
    ...
    function c(b) {
      b.done ? s(b.value) : i(b.value).then(o, l);
    }
...
function hs(e, t, r) {
  ...
  function l(v) {
    v.value instanceof Se ? Promise.resolve(v.value.v).then(c, b) : g(s[0][2], v);
  }
  function c(v) {
    o("next", v);
  }
  ...
  function g(v, y) {
    v(y), s.shift(), s.length && o(s[0][0], s[0][1]);
  }
}
function ps(e) {
  if (!Symbol.asyncIterator) throw new TypeError("Symbol.asyncIterator is not defined.");
  var t = e[Symbol.asyncIterator], r;
  return t ? t.call(e) : (e = typeof Ce == "function" ? Ce(e) : e[Symbol.iterator](), r = {}, n("next"), n("throw"), n("return"), r[Symbol.asyncIterator] = function() {
    return this;
  }, r);
  function n(s) {
    r[s] = e[s] && function(a) {
    ...
    if (!this.closed) {
      ...
      if (a)
        if (this._parentage = null, Array.isArray(a))
          try {
            for (var o = Ce(a), l = o.next(); !l.done; l = o.next()) {
              var c = l.value;
              c.remove(this);
            }
          } catch (_) {
      ...
      if (C(b))
        try {
          ...
          s = _ instanceof jt ? _.errors : [_];
        }
      var g = this._finalizers;
      if (g) {
        this._finalizers = null;
        try {
          for (var v = Ce(g), y = v.next(); !y.done; y = v.next()) {
            var k = y.value;
            try {
              Ir(k);
            } catch (_) {
              s = s ?? [], _ instanceof jt ? s = Ve(Ve([], Ee(s)), Ee(_.errors)) : s.push(_);
            }
          }
        } catch (_) {
          n = { error: _ };
...
var kn = {
  ...
  setTimeout: function(e, t) {
    for (var r = [], n = 2; n < arguments.length; n++)
      r[n - 2] = arguments[n];
    return setTimeout.apply(void 0, Ve([e, t], Ee(r)));
  },
...
var nr = function(e) {
  ...
  function t(r) {
    ...
    return n.isStopped = !1, r ? (n.destination = r, $n(r) && r.add(n)) : n.destination = vs, n;
  }
...
var gs = function() {
  ...
  function t(r, n, i) {
    ...
    if (C(r) || !r)
      ...
      var o;
      s && kn.useDeprecatedNextContext ? (o = Object.create(r), o.unsubscribe = function() {
        return s.unsubscribe();
      }, a = {
        next: r.next && Rt(r.next, o),
        error: r.error && Rt(r.error, o),
        complete: r.complete && Rt(r.complete, o)
      }) : a = r;
    }
    return s.destination = new gs(a), s;
  }
  return t;
}(nr);
function ut(e) {
...
var I = function() {
  ...
  return e.prototype.lift = function(t) {
    ...
    var i = this, s = ws(t) ? t : new Vt(t, r, n);
    return ht(function() {
    ...
    var n = this;
    return r = Lr(r), new r(function(i, s) {
      var a = new Vt({
        next: function(o) {
          try {
            t(o);
...
function ws(e) {
  return e && e instanceof nr || ys(e) && $n(e);
}
function xs(e) {
  return C(e?.lift);
}
...
var $s = function(e) {
  ...
  return t.prototype.lift = function(r) {
    ...
    ht(function() {
      ...
      if (n._throwIfClosed(), !n.isStopped) {
        ...
        try {
          for (var a = Ce(n.currentObservers), o = a.next(); !o.done; o = a.next()) {
            var l = o.value;
            l.next(r);
          }
        } catch (c) {
    ...
    return s || a ? xn : (this.currentObservers = null, o.push(r), new Te(function() {
      n.currentObservers = null, yt(o, r);
    }));
  ...
  setInterval: function(e, t) {
    for (var r = [], n = 2; n < arguments.length; n++)
      r[n - 2] = arguments[n];
    return setInterval.apply(void 0, Ve([e, t], Ee(r)));
  },
  ...
  return t.prototype.schedule = function(r, n) {
    ...
    return i === void 0 && (i = 0), qt.setInterval(r.flush.bind(r, this), i);
    ...
    if (!this.closed) {
      ...
      this.work = this.state = this.scheduler = null, this.pending = !1, yt(s, this), n != null && (this.id = this.recycleAsyncId(i, n, null)), this.delay = null, e.prototype.unsubscribe.call(this);
    }
  }, t;
}(As), Ur = function() {
  function e(t, r) {
...
}(Ur), ar = new Cs(Ss), Es = ar, Ms = new I(function(e) {
  return e.complete();
});
function Cn(e) {
    ...
    return yn(this, function(a) {
      switch (a.label) {
        ...
        case 2:
          return [4, Se(r.read())];
        case 3:
          return n = a.sent(), i = n.value, s = n.done, s ? [4, Se(void 0)] : [3, 5];
        case 4:
          return [2, a.sent()];
        case 5:
          return [4, Se(i)];
...
function js(e) {
  return new I(function(t) {
    var r, n;
    try {
      for (var i = Ce(e), s = i.next(); !s.done; s = i.next()) {
        var a = s.value;
...
function Bs(e, t) {
  ...
  return ds(this, void 0, void 0, function() {
    var a, o;
    return yn(this, function(l) {
      switch (l.label) {
        case 0:
          l.trys.push([0, 5, 6, 11]), r = ps(e), l.label = 1;
        case 1:
          return [4, r.next()];
        case 2:
...
function In(e, t) {
  return t === void 0 && (t = 0), Pe(function(r, n) {
    r.subscribe(be(n, function(i) {
...
function Zs(e, t) {
  return qs(t) ? e.apply(void 0, Ve([], Ee(t))) : e(t);
}
function Ws(e) {
...
function Ys(e, t, r, n, i, s, a, o) {
  var l = [], c = 0, b = 0, g = !1, v = function() {
    g && !l.length && !c && t.complete();
  }, y = function(_) {
    return c < n ? k(_) : l.push(_);
  }, k = function(_) {
    c++;
    var P = !1;
    ue(r(_, b++)).subscribe(be(t, function(O) {
      t.next(O);
    }, function() {
      P = !0;
    }, void 0, function() {
  ...
  return e.subscribe(be(t, y, function() {
    g = !0, v();
  })), function() {
  };
}
function cr(e, t, r) {
  return r === void 0 && (r = 1 / 0), C(t) ? cr(function(n, i) {
    return lr(function(s, a) {
      return t(n, s, i, a);
    })(ue(e(n, i)));
  }, r) : (typeof t == "number" && (r = t), Pe(function(n, i) {
    return Ys(n, i, e, r);
  }));
}
function Gs(e) {
  return e === void 0 && (e = 1 / 0), cr(sr, e);
}
var Js = ["addListener", "removeListener"], Qs = ["addEventListener", "removeEventListener"], Xs = ["on", "off"];
function qe(e, t, r, n) {
  if (C(r) && (n = r, r = void 0), n)
    return qe(e, t, r).pipe(Ws(n));
  var i = Ee(ra(e) ? Qs.map(function(o) {
    return function(l) {
      return e[o](t, l, r);
    };
  }) : ea(e) ? Js.map(Hr(e, t)) : ta(e) ? Xs.map(Hr(e, t)) : [], 2), s = i[0], a = i[1];
  if (!s && or(e))
...
function na(e, t, r) {
  r === void 0 && (r = Es);
  var n = -1;
  return Cn(t) ? r = t : n = t, new I(function(i) {
    var s = Vs(e) ? +e - r.now() : e;
    s < 0 && (s = 0);
    var a = 0;
...
function ia(e, t) {
  return t === void 0 && (t = ar), na(e, e, t);
}
function sa() {
  for (var e = [], t = 0; t < arguments.length; t++)
    e[t] = arguments[t];
  var r = Mn(e), n = Ts(e, 1 / 0), i = e;
  return i.length ? i.length === 1 ? ue(i[0]) : Gs(n)(Un(i, r)) : Ms;
}
function aa(e) {
  return Pe(function(t, r) {
    var n = !1, i = null;
    t.subscribe(be(r, function(s) {
      n = !0, i = s;
    })), ue(e).subscribe(be(r, function() {
      if (n) {
        n = !1;
        var s = i;
        i = null, r.next(s);
 ...
 */
class da {
  constructor(t, { target: r, config: n, callback: i, skipInitial: s }) {
    this.t = /* @__PURE__ */ new Set(), this.o = !1, this.i = !1, this.h = t, r !== null && this.t.add(r ?? t), this.l = n, this.o = s ?? this.o, this.callback = i, window.ResizeObserver ? (this.u = new ResizeObserver((a) => {
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const et = { ATTRIBUTE: 1, CHILD: 2, PROPERTY: 3, BOOLEAN_ATTRIBUTE: 4, EVENT: 5, ELEMENT: 6 }, tt = (e) => (...t) => ({ _$litDirective$: e, values: t });
class rt {
  constructor(t) {
  }
  get _$AU() {
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const Kn = "important", ha = " !" + Kn, pa = tt(class extends rt {
  constructor(e) {
  ...
  update(e, [t]) {
    ...
    for (const n in t) {
      ...
      if (i != null) {
        this.ft.add(n);
        const s = typeof i == "string" && i.endsWith(ha);
        n.includes("-") || s ? r.setProperty(n, s ? i.slice(0, -11) : i, s ? Kn : "") : r[n] = i;
      }
    }
    return Q;
  }
}), fa = ":host{--mte-drawer-height-half-open:120px}:host([mode=closed]){height:0}:host([mode=half]){height:var(--mte-drawer-height-half-open)}:host([mode=open]){height:50%}";
var Vn = Object.defineProperty, ga = Object.getOwnPropertyDescriptor, qn = (e) => {
  throw TypeError(e);
}, ma = (e, t, r) => t in e ? Vn(e, t, { enumerable: !0, configurable: !0, writable: !0, value: r }) : e[t] = r, Et = (e, t, r, n) => {
  for (var i = n > 1 ? void 0 : n ? ga(t, r) : t, s = e.length - 1, a; s >= 0; s--)
    (a = e[s]) && (i = (n ? a(t, r, i) : a(i)) || i);
  return n && i && Vn(t, r, i), i;
}, Zn = (e, t, r) => ma(e, typeof t != "symbol" ? t + "" : t, r), Wn = (e, t, r) => t.has(e) || qn("Cannot " + r), va = (e, t, r) => (Wn(e, t, "read from private field"), t.get(e)), ba = (e, t, r) => t.has(e) ? qn("Cannot add the same private member more than once") : t instanceof WeakSet ? t.add(e) : t.set(e, r), ya = (e, t, r, n) => (Wn(e, t, "write to private field"), t.set(e, r), r), pt;
const wa = 120;
let Me = class extends Z {
  constructor() {
    super(), ba(this, pt), Zn(this, "toggleReadMore", (e) => {
      this.mode === "open" ? this.mode = "half" : this.mode = "open", e.preventDefault(), e.stopImmediatePropagation();
    }), this.mode = "closed", this.hasDetail = !1, ya(this, pt, new da(this, {
      callback: (e) => {
  ...
  get toggleMoreLabel() {
    switch (this.mode) {
      case "half":
        return m`${E("🔼", "up arrow")} More`;
      case "open":
        return m`${E("🔽", "down arrow")} Less`;
      case "closed":
        return $;
    }
  }
  render() {
    const e = va(this, pt).value?.height, t = pa({ height: e ? `${e}px` : void 0 });
    return m`<aside @click="${(r) => r.stopPropagation()}" style="${t}" class="ml-6 mr-3 mt-4 overflow-y-auto">
      <header class="w-full pb-4">
        <h2>
          <slot name="header"></slot>
          ${Ze(
      this.hasDetail,
      m`<button data-testId="btnReadMoreToggle" class="ml-2 align-middle" @click="${this.toggleReadMore}">${this.toggleMoreLabel}</button>`
    )}
        </h2>
      </header>
      <div class="motion-safe:transition-max-width">
        <slot name="summary"></slot>
        ${Ze(this.hasDetail && this.mode === "open", m`<slot name="detail"></slot>`)}
      </div>
    </aside>`;
  }
};
...
], Me.prototype, "hasDetail", 2);
Et([
  A()
], Me.prototype, "toggleMoreLabel", 1);
Me = Et([
  B("mte-drawer")
], Me);
function Ze(e, t) {
  return e ? typeof t == "function" ? t() : t : $;
}
function Le(e, t) {
  return e == null ? $ : t(e);
}
...
function xt(...e) {
  ...
  return new URL(`#${e.filter(Boolean).join("/")}`, t).href;
}
function Gn(e) {
  return e.length > 1 ? "s" : "";
}
...
function Qn(e) {
  e && !ka(e) && e.scrollIntoView({ block: "center", behavior: "smooth" });
}
function ka(e) {
  const { top: t, bottom: r } = e.getBoundingClientRect();
  return t >= 0 && r <= (window.innerHeight || document.documentElement.clientHeight) - wa;
}
function Kr() {
  const e = "test";
  try {
...
class ae extends Z {
  ...
  #e = new Te();
  connectedCallback() {
    super.connectedCallback(), this.#e.add(Xn.subscribe(() => this.shouldReactivate() && this.reactivate()));
  }
  disconnectedCallback() {
    super.disconnectedCallback(), this.#e.unsubscribe();
  }
}
var ei = Object.defineProperty, _a = Object.getOwnPropertyDescriptor, Aa = (e, t, r) => t in e ? ei(e, t, { enumerable: !0, configurable: !0, writable: !0, value: r }) : e[t] = r, q = (e, t, r, n) => {
  for (var i = n > 1 ? void 0 : n ? _a(t, r) : t, s = e.length - 1, a; s >= 0; s--)
    (a = e[s]) && (i = (n ? a(t, r, i) : a(i)) || i);
  return n && i && ei(t, r, i), i;
}, Sa = (e, t, r) => Aa(e, t + "", r);
const Ca = 100;
let L = class extends ae {
  ...
  constructor() {
    super(), this.context = { view: G.mutant, path: [] }, this.path = [];
  }
  firstUpdated() {
    (this.path.length === 0 || this.path[0] !== G.mutant && this.path[0] !== G.test) && window.location.replace(xt(`${G.mutant}`));
  }
  async loadData() {
    if (this.src)
      try {
  ...
  async willUpdate(e) {
    this.report && (this.theme || (this.theme = this.getTheme()), e.has("report") && this.updateModel(this.report), (e.has("path") || e.has("report")) && (this.updateContext(), this.updateTitle())), e.has("src") && await this.loadData();
  }
  ...
  getTheme() {
    const e = Kr() && localStorage.getItem("mutation-testing-elements-theme");
    return e || (window.matchMedia && window.matchMedia("(prefers-color-scheme: dark)")?.matches ? "dark" : "light");
  }
  updateModel(e) {
    this.rootModel = is(e), t((r, n) => {
      r.result = n, r.mutants.forEach((i) => this.mutants.set(i.id, i));
    })(this.rootModel?.systemUnderTestMetrics), t((r, n) => {
      r.result = n, r.tests.forEach((i) => this.tests.set(i.id, i));
    })(this.rootModel?.testMetrics), this.rootModel.systemUnderTestMetrics.updateParent(), this.rootModel.testMetrics?.updateParent();
    function t(r) {
      return function n(i) {
        i?.file && r(i.file, i), i?.childResults.forEach((s) => {
          n(s);
        });
      };
    }
  ...
  updateContext() {
    if (this.rootModel) {
      const e = (r, n) => n.reduce(
        (i, s) => i?.childResults.find((a) => a.name === s),
        r
      ), t = this.path.slice(1);
      this.path[0] === G.test && this.rootModel.testMetrics ? this.context = {
        view: G.test,
        path: t,
  ...
  themeSwitch = (e) => {
    this.theme = e.detail, Kr() && localStorage.setItem("mutation-testing-elements-theme", this.theme);
  };
  subscriptions = [];
  connectedCallback() {
    super.connectedCallback(), this.subscriptions.push(ca.subscribe((e) => this.path = e)), this.initializeSse();
  }
  source;
  ...
  initializeSse() {
    ...
    const e = qe(this.source, "mutant-tested").subscribe((r) => {
      const n = JSON.parse(r.data);
      if (!this.report)
        return;
      const i = this.mutants.get(n.id);
      if (i !== void 0) {
        this.theMutant = i;
        for (const [s, a] of Object.entries(n))
          this.theMutant[s] = a;
        n.killedBy && n.killedBy.forEach((s) => {
          const a = this.tests.get(s);
          a !== void 0 && (this.theTest = a, a.addKilled(this.theMutant), this.theMutant.addKilledBy(a));
        }), n.coveredBy && n.coveredBy.forEach((s) => {
          const a = this.tests.get(s);
          a !== void 0 && (this.theTest = a, a.addCovered(this.theMutant), this.theMutant.addCoveredBy(a));
        });
      }
    }), t = qe(this.source, "mutant-tested").pipe(oa(Ca)).subscribe(() => {
      this.applyChanges();
    });
  ...
  applyChanges() {
    this.theMutant?.update(), this.theTest?.update(), Xn.next();
  }
  disconnectedCallback() {
    super.disconnectedCallback(), this.subscriptions.forEach((e) => e.unsubscribe());
  }
  renderTitle() {
    return this.context.result ? m`
  ...
  render() {
    return this.context.result ?? this.errorMessage ? m`
  ...
  renderErrorMessage() {
    return this.errorMessage ? m`<div class="my-4 rounded-lg bg-red-100 p-4 text-sm text-red-700" role="alert">${this.errorMessage}</div>` : $;
  }
  renderTabs() {
    if (this.rootModel?.testMetrics) {
      ...
      return m`
        ...
        ({ type: r, isActive: n, text: i }) => m`<li class="mr-2" role="presentation">
                  <a
...
Sa(L, "styles", [us, H(ua), N]);
q([
  A({ attribute: !1 })
], L.prototype, "report", 2);
q([
  A({ attribute: !1 })
], L.prototype, "rootModel", 2);
q([
  A()
], L.prototype, "src", 2);
q([
...
q([
  A({ attribute: "title-postfix" })
], L.prototype, "titlePostfix", 2);
q([
  A({ reflect: !0 })
], L.prototype, "theme", 2);
q([
  A({ attribute: !1 })
], L.prototype, "themeBackgroundColor", 1);
q([
  A()
], L.prototype, "title", 1);
L = q([
  B("mutation-test-report-app")
], L);
/**
 * @license
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const { I: Ea } = Li, Ma = (e) => e.strings === void 0, Vr = () => document.createComment(""), Be = (e, t, r) => {
  const n = e._$AA.parentNode, i = t === void 0 ? e._$AB : t._$AA;
  if (r === void 0) {
    const s = n.insertBefore(Vr(), i), a = n.insertBefore(Vr(), i);
    r = new Ea(s, a, e, e.options);
  } else {
    const s = r._$AB.nextSibling, a = r._$AM, o = a !== e;
    if (o) {
      let l;
  ...
  return r;
}, he = (e, t, r = e) => (e._$AI(t, r), e), Ta = {}, Pa = (e, t = Ta) => e._$AH = t, Fa = (e) => e._$AH, Dt = (e) => {
  e._$AP?.(!1, !0);
  let t = e._$AA;
...
const Ne = (e, t) => {
  ...
  for (const n of r) n._$AO?.(t, !1), Ne(n, t);
  return !0;
}, $t = (e) => {
  let t, r;
  do {
...
function za(e) {
  this._$AN !== void 0 ? ($t(this), this._$AM = e, ti(this)) : this._$AM = e;
}
function Oa(e, t = !1, r = 0) {
  const n = this._$AH, i = this._$AN;
  if (i !== void 0 && i.size !== 0) if (t) if (Array.isArray(n)) for (let s = r; s < n.length; s++) Ne(n[s], !1), $t(n[s]);
  else n != null && (Ne(n, !1), $t(n));
  else Ne(this, e);
}
const ja = (e) => {
  e.type == et.CHILD && (e._$AP ??= Oa, e._$AQ ??= za);
};
class Ra extends rt {
  constructor() {
  ...
  _$AT(t, r, n) {
    super._$AT(t, r, n), ti(this), this.isConnected = t._$AU;
  }
  _$AO(t, r = !0) {
    t !== this.isConnected && (this.isConnected = t, t ? this.reconnected?.() : this.disconnected?.()), r && (Ne(this, t), $t(this));
  }
  setValue(t) {
    if (Ma(this.t)) this.t._$AI(t, this);
    else {
      const r = [...this.t._$AH];
      r[this.i] = t, this.t._$AI(r, this, 0);
    }
  }
  disconnected() {
  }
...
const It = /* @__PURE__ */ new WeakMap(), Ia = tt(class extends Ra {
  render(e) {
    return $;
  }
  update(e, [t]) {
    const r = t !== this.Y;
    return r && this.Y !== void 0 && this.rt(void 0), (r || this.lt !== this.ct) && (this.Y = t, this.ht = e.options?.host, this.rt(this.ct = e.element)), $;
  }
  rt(e) {
    if (this.isConnected || (e = void 0), typeof this.Y == "function") {
      const t = this.ht ?? globalThis;
      let r = It.get(t);
      r === void 0 && (r = /* @__PURE__ */ new WeakMap(), It.set(t, r)), r.get(this.Y) !== void 0 && this.Y.call(this.ht, void 0), r.set(this.Y, e), e !== void 0 && this.Y.call(this.ht, e);
    } else this.Y.value = e;
  }
  get lt() {
    return typeof this.Y == "function" ? It.get(this.ht ?? globalThis)?.get(this.Y) : this.Y?.value;
  }
  disconnected() {
...
var K = /* @__PURE__ */ ((e) => (e.csharp = "cs", e.java = "java", e.javascript = "javascript", e.html = "html", e.php = "php", e.scala = "scala", e.typescript = "typescript", e.vue = "vue", e.gherkin = "gherkin", e.svelte = "svelte", e.rust = "rust", e))(K || {});
function La(e) {
...
function Wt(e, t) {
  const r = ur(t) ?? "plain";
  let n = r;
  return r === "vue" && (n = "html"), Br.highlight(e, Br.languages[n], n);
}
function Yt(e, t) {
  let r = [];
  const n = [], i = {
  ...
  let a = !1, o = 0;
  for (; o < e.length; ) {
    switch (a && !ft(e[o]) && (c(), a = !1), e[o]) {
      case "\r":
        i.offset++;
        break;
      case `
`:
        v(), i.offset++, i.line++, i.column = 0, a = !0;
        break;
      case "<": {
        const u = k();
        u.isClosing ? P(u) : _(u);
  ...
  function b() {
    s.forEach((u) => l(g({ ...u, isClosing: !0 })));
  }
  function g({ attributes: u, elementName: p, isClosing: w }) {
    return w ? `</${p}>` : `<${p}${Object.entries(u ?? {}).reduce(
      (S, [x, T]) => T === void 0 ? `${S} ${x}` : `${S} ${x}="${T}"`,
      ""
    )}>`;
  }
  function v() {
  ...
  function y(u) {
    if (i.column++, i.offset++, t)
      for (const p of t(i))
        p.isClosing ? P(p) : (l(g(p)), s.push(p));
    l(u);
  }
  function k() {
    o++;
    ...
    for (; !ft(e[o]) && e[o] !== ">"; )
      o++;
    const w = e.substring(p, o), S = O();
    return { elementName: w, attributes: S, isClosing: u };
  }
  function _(u) {
    s.push(u), l(g(u));
  }
  function P(u) {
    ...
    if (p === -1)
      throw new Error(`Cannot find corresponding opening tag for ${g(u)}`);
  }
  function O() {
...
class Gt extends rt {
  constructor(t) {
    if (super(t), this.it = $, t.type !== et.CHILD) throw Error(this.constructor.directiveName + "() can only be used in child bindings");
  }
  render(t) {
...
const Ha = tt(Gt);
function ri(e, t) {
  return e === $ && t === $ ? $ : m`<span class="ml-1 flex flex-row items-center">${e}${t}</span>`;
}
function ni(e, t) {
  return m`<tr class="line"
    ><td class="line-number"></td><td class="line-marker"></td><td class="code flex"><span>${Ha(e)}</span>${t}</td></tr
  >`;
}
var ii = Object.defineProperty, Ka = Object.getOwnPropertyDescriptor, Va = (e, t, r) => t in e ? ii(e, t, { enumerable: !0, configurable: !0, writable: !0, value: r }) : e[t] = r, xe = (e, t, r, n) => {
  for (var i = n > 1 ? void 0 : n ? Ka(t, r) : t, s = e.length - 1, a; s >= 0; s--)
    (a = e[s]) && (i = (n ? a(t, r, i) : a(i)) || i);
  return n && i && ii(t, r, i), i;
}, qa = (e, t, r) => Va(e, t + "", r);
const Lt = "diff-old", qr = "diff-new";
let ne = class extends ae {
  codeRef = Ba();
  constructor() {
    super(), this.filters = [], this.selectedMutantStates = [], this.lines = [], this.mutants = [];
  }
  filtersChanged = (e) => {
  ...
  codeClicked = (e) => {
    if (e.stopPropagation(), e.target instanceof Element) {
      ...
      for (; t instanceof Element; t = t.parentElement) {
        const i = t.getAttribute("mutant-id"), s = this.mutants.find(({ id: a }) => a.toString() === i);
        s && r.push(s);
      }
      const n = (this.selectedMutant ? r.indexOf(this.selectedMutant) : -1) + 1;
      r[n] ? (this.toggleMutant(r[n]), Wr()) : this.selectedMutant && (this.toggleMutant(this.selectedMutant), Wr());
    }
  };
  render() {
    ...
    const t = (r) => this.renderMutantDots([...e.entries()].filter(([n]) => n > r).flatMap(([, n]) => n));
    return m`
      <mte-state-filter
        allow-toggle-all
      ...
      >
        <code ${Ia(this.codeRef)} class="flex language-${this.model.language}">
          <table>${this.lines.map((r, n) => {
      const i = n + 1, s = this.renderMutantDots(e.get(i)), a = this.lines.length === i ? t(i) : $;
      return ni(r, ri(s, a));
    })}</table>
          </code>
          </pre>
  ...
  renderMutantDots(e) {
    return e?.length ? e.map(
      (t) => R`<svg mutant-id="${t.id}" class="mutant-dot ${this.selectedMutant?.id === t.id ? "selected" : t.status}" height="10" width="12">
          <title>${Zr(t)}</title>
  ...
  toggleMutant(e) {
    if (this.removeCurrentDiff(), this.selectedMutant === e) {
      this.selectedMutant = void 0, this.dispatchEvent(re("mutant-selected", { selected: !1, mutant: e }));
      return;
    }
    this.selectedMutant = e;
    const t = this.codeRef.value.querySelectorAll("tr.line");
    for (let i = e.location.start.line - 1; i < e.location.end.line; i++)
      t.item(i).classList.add(Lt);
    const r = this.highlightedReplacementRows(e), n = t.item(e.location.end.line - 1);
    n.insertAdjacentHTML("afterend", r), Qn(n), this.dispatchEvent(re("mutant-selected", { selected: !0, mutant: e }));
  }
  removeCurrentDiff() {
    this.codeRef.value.querySelectorAll(`.${Lt}`).forEach((r) => r.classList.remove(Lt)), this.codeRef.value.querySelectorAll(`.${qr}`).forEach((r) => r.remove());
  }
  reactivate() {
    super.reactivate(), this.updateFileRepresentation();
  }
  update(e) {
    e.has("model") && this.model && this.updateFileRepresentation(), (e.has("model") && this.model || e.has("selectedMutantStates")) && (this.mutants = this.model.mutants.filter((t) => this.selectedMutantStates.includes(t.status)).sort((t, r) => gt(t.location.start, r.location.start) ? 1 : -1), this.selectedMutant && !this.mutants.includes(this.selectedMutant) && e.has("selectedMutantStates") && // This extra check is to allow mutants that have been opened before, to stay open when a realtime update comes through
  ...
  updateFileRepresentation() {
    this.filters = ["Killed", "Survived", "NoCoverage", "Ignored", "Timeout", "CompileError", "RuntimeError"].filter((n) => this.model.mutants.some((i) => i.status === n)).map((n) => ({
      enabled: [...this.selectedMutantStates, "Survived", "NoCoverage", "Timeout"].includes(n),
      count: this.model.mutants.filter((i) => i.status === n).length,
      status: n,
      label: m`${Yn(n)} ${n}`,
      context: xa(n)
    }));
    const e = Wt(this.model.source, this.model.name), t = /* @__PURE__ */ new Set(), r = new Set(this.model.mutants);
    this.lines = Yt(e, function* (n) {
      for (const i of t)
        gt(n, i.location.end) && (t.delete(i), yield { elementName: "span", id: i.id, isClosing: !0 });
      for (const i of r)
        gt(n, i.location.start) && (t.add(i), r.delete(i), yield {
          elementName: "span",
          id: i.id,
          attributes: {
            class: Bt(`mutant border-none ${i.status}`),
            title: Bt(Zr(i)),
            "mutant-id": Bt(i.id.toString())
          }
        });
    });
  }
  ...
  highlightedReplacementRows(e) {
    const t = e.getMutatedLines().trimEnd(), r = e.getOriginalLines().trimEnd(), [n, i] = Na(r, t), s = Yt(Wt(t, this.model.name), function* ({ offset: l }) {
      l === n ? yield { elementName: "span", id: "diff-focus", attributes: { class: "diff-focus" } } : l === i && (yield { elementName: "span", id: "diff-focus", isClosing: !0 });
    }), a = `<tr class="${qr}"><td class="empty-line-number"></td><td class="line-marker"></td><td class="code">`, o = "</td></tr>";
    return s.map((l) => `${a}${l}${o}`).join("");
  }
};
qa(ne, "styles", [bn, N, H(Ua)]);
xe([
  W()
], ne.prototype, "filters", 2);
xe([
  A()
], ne.prototype, "model", 2);
xe([
  W()
], ne.prototype, "selectedMutantStates", 2);
xe([
  W()
], ne.prototype, "selectedMutant", 2);
xe([
  W()
], ne.prototype, "lines", 2);
xe([
  W()
], ne.prototype, "mutants", 2);
ne = xe([
  B("mte-file")
], ne);
function Zr(e) {
...
const Yr = (e, t, r) => {
  ...
  dt(e, t, r) {
    ...
    const i = [], s = [];
    let a = 0;
    for (const o of e) i[a] = n ? n(o, a) : a, s[a] = r(o, a), a++;
  ...
  update(e, [t, r, n]) {
    const i = Fa(e), { values: s, keys: a } = this.dt(t, r, n);
    if (!Array.isArray(i)) return this.ut = a, s;
    const o = this.ut ??= [], l = [];
    let c, b, g = 0, v = i.length - 1, y = 0, k = s.length - 1;
    for (; g <= v && y <= k; ) if (i[g] === null) g++;
    else if (i[v] === null) v--;
    else if (o[g] === a[y]) l[y] = he(i[g], s[y]), g++, y++;
    else if (o[v] === a[k]) l[k] = he(i[v], s[k]), v--, k--;
    else if (o[g] === a[k]) l[k] = he(i[g], s[k]), Be(e, l[k + 1], i[g]), g++, k--;
    else if (o[v] === a[y]) l[y] = he(i[v], s[y]), Be(e, i[g], i[v]), v--, y++;
    else if (c === void 0 && (c = Yr(a, y, k), b = Yr(o, g, v)), c.has(o[g])) if (c.has(o[v])) {
      const _ = b.get(a[y]), P = _ !== void 0 ? i[_] : null;
      if (P === null) {
        const O = Be(e, i[g]);
        he(O, s[y]), l[y] = O;
      } else l[y] = he(P, s[y]), Be(e, i[g], P), i[_] = null;
      y++;
    } else Dt(i[v]), v--;
    else Dt(i[g]), g++;
    for (; y <= k; ) {
    ...
    return this.ut = a, Pa(e, l), Q;
  }
});
var si = Object.defineProperty, Za = Object.getOwnPropertyDescriptor, Wa = (e, t, r) => t in e ? si(e, t, { enumerable: !0, configurable: !0, writable: !0, value: r }) : e[t] = r, dr = (e, t, r, n) => {
  for (var i = n > 1 ? void 0 : n ? Za(t, r) : t, s = e.length - 1, a; s >= 0; s--)
    (a = e[s]) && (i = (n ? a(t, r, i) : a(i)) || i);
...
let Ye = class extends Z {
  ...
  render() {
    return m`<nav class="my-4 flex rounded-md border border-primary-600 bg-primary-100 p-3 text-gray-700" aria-label="Breadcrumb">
  ...
  renderBreadcrumbItems() {
    if (this.path) {
      ...
      return We(
        e,
        (t) => t,
        (t, r) => r === e.length - 1 ? this.renderActiveItem(t) : this.renderLink(t, e.slice(0, r + 1))
      );
    }
  }
  renderActiveItem(e) {
    return m`<li aria-current="page">
      <span class="ml-1 text-sm font-medium text-gray-800">${e}</span>
    </li> `;
  }
  renderLink(e, t) {
    return m`<li class="after:text-gray-800 after:content-['/'] md:after:pl-1">
      <a
        href="${xt(this.view, ...t)}"
...
const Ga = ".step-button{align-items:center;border-radius:.375rem;display:inline-flex;margin-right:.5rem;--tw-bg-opacity:1;background-color:rgb(var(--mut-primary-600,2 132 199)/var(--tw-bg-opacity));padding:.25rem;text-align:center;--tw-text-opacity:1;color:rgb(var(--mut-white,255 255 255)/var(--tw-text-opacity))}.step-button:hover{--tw-bg-opacity:1;background-color:rgb(var(--mut-primary-700,3 105 161)/var(--tw-bg-opacity))}.step-button:focus{outline:2px solid #0000;outline-offset:2px;--tw-ring-offset-shadow:var(--tw-ring-inset) 0 0 0 var(--tw-ring-offset-width) var(--tw-ring-offset-color);--tw-ring-shadow:var(--tw-ring-inset) 0 0 0 calc(2px + var(--tw-ring-offset-width)) var(--tw-ring-color);box-shadow:var(--tw-ring-offset-shadow),var(--tw-ring-shadow),var(--tw-shadow,0 0 #0000);--tw-ring-opacity:1;--tw-ring-color:rgb(var(--mut-primary-500,14 165 233)/var(--tw-ring-opacity))}";
var ai = Object.defineProperty, Ja = Object.getOwnPropertyDescriptor, Qa = (e, t, r) => t in e ? ai(e, t, { enumerable: !0, configurable: !0, writable: !0, value: r }) : e[t] = r, oi = (e, t, r, n) => {
  for (var i = n > 1 ? void 0 : n ? Ja(t, r) : t, s = e.length - 1, a; s >= 0; s--)
    (a = e[s]) && (i = (n ? a(t, r, i) : a(i)) || i);
...
let kt = class extends ae {
  ...
  next = (e) => {
    e.stopPropagation(), this.dispatchEvent(re("next", void 0, { bubbles: !0, composed: !0 }));
  };
  previous = (e) => {
    e.stopPropagation(), this.dispatchEvent(re("previous", void 0, { bubbles: !0, composed: !0 }));
  };
  render() {
    return m`
...
let _t = class extends Z {
  dispatchThemeChangedEvent = (t) => {
    ...
    this.dispatchEvent(re("theme-switch", r ? "dark" : "light"));
  };
  render() {
    return m`
...
const ui = ({ hasDetail: e, mode: t }, r) => m`<mte-drawer
...
var di = Object.defineProperty, io = Object.getOwnPropertyDescriptor, so = (e, t, r) => t in e ? di(e, t, { enumerable: !0, configurable: !0, writable: !0, value: r }) : e[t] = r, hr = (e, t, r, n) => {
  for (var i = n > 1 ? void 0 : n ? io(t, r) : t, s = e.length - 1, a; s >= 0; s--)
    (a = e[s]) && (i = (n ? a(t, r, i) : a(i)) || i);
  return n && i && di(t, r, i), i;
}, ao = (e, t, r) => so(e, t + "", r);
const Gr = (e) => `${e.name}${e.sourceFile && e.location ? ` (${Jn(e)})` : ""}`, Jr = (e) => m`<span class="whitespace-pre-wrap">${e}</span>`;
let Ge = class extends ae {
  ...
  render() {
    return ui(
      ...
      { hasDetail: !!(this.mutant?.killedByTests?.length || this.mutant?.coveredByTests?.length), mode: this.mode },
      Le(
        this.mutant,
        (e) => m`
          <span class="align-middle text-lg" slot="header"
            >${Yn(e.status)} ${e.mutatorName} ${e.status}
  ...
  renderSummary() {
    return Hn(
      m`${this.mutant?.killedByTests?.[0] ? pe(
        m`${E("🎯", "killed")} Killed by:
            ${this.mutant.killedByTests?.[0].name}${this.mutant.killedByTests.length > 1 ? `(and ${this.mutant.killedByTests.length - 1} more)` : ""}`
      ) : $}
      ${Ze(this.mutant?.static, pe(m`${E("🗿", "static")} Static mutant`))}
      ${Le(
        this.mutant?.coveredByTests,
        (e) => pe(
          m`${E("☂️", "umbrella")} Covered by ${e.length}
          test${Gn(e)}${this.mutant?.status === "Survived" ? " (yet still survived)" : ""}`
        )
      )}
      ${Ze(
        this.mutant?.statusReason?.trim(),
        pe(
          m`${E("🕵️", "spy")} ${Jr(this.mutant.statusReason)}`,
  ...
  renderDetail() {
    return m`<ul class="mb-12 mr-3">
      ${this.mutant?.killedByTests?.map(
      (e) => wt("This mutant was killed by this test", m`${E("🎯", "killed")} ${Gr(e)}`)
    )}
      ${this.mutant?.coveredByTests?.filter((e) => !this.mutant?.killedByTests?.includes(e)).map((e) => wt("This mutant was covered by this test", m`${E("☂️", "umbrella")} ${Gr(e)}`))}
    </ul>`;
  }
};
ao(Ge, "styles", [N]);
...
const oo = "main{padding-bottom:var(--mte-drawer-height-half-open)}";
var hi = Object.defineProperty, lo = Object.getOwnPropertyDescriptor, co = (e, t, r) => t in e ? hi(e, t, { enumerable: !0, configurable: !0, writable: !0, value: r }) : e[t] = r, Fe = (e, t, r, n) => {
  for (var i = n > 1 ? void 0 : n ? lo(t, r) : t, s = e.length - 1, a; s >= 0; s--)
    (a = e[s]) && (i = (n ? a(t, r, i) : a(i)) || i);
  ...
  render() {
    return m`
      <main @click="${this.handleClick}">
        <mte-metrics-table .columns="${ho}" .currentPath="${this.path}" .thresholds="${this.thresholds}" .model="${this.result}">
        </mte-metrics-table>
...
Fe([
  A()
], le.prototype, "drawerMode", 2);
Fe([
  A()
], le.prototype, "selectedMutant", 2);
Fe([
  A()
], le.prototype, "result", 2);
Fe([
  A({ attribute: !1, reflect: !1 })
], le.prototype, "thresholds", 2);
Fe([
  A({ attribute: !1, reflect: !1 })
], le.prototype, "path", 2);
le = Fe([
...
], po = "main{padding-bottom:var(--mte-drawer-height-half-open)}";
var pi = Object.defineProperty, fo = Object.getOwnPropertyDescriptor, go = (e, t, r) => t in e ? pi(e, t, { enumerable: !0, configurable: !0, writable: !0, value: r }) : e[t] = r, nt = (e, t, r, n) => {
  for (var i = n > 1 ? void 0 : n ? fo(t, r) : t, s = e.length - 1, a; s >= 0; s--)
    (a = e[s]) && (i = (n ? a(t, r, i) : a(i)) || i);
...
let ye = class extends ae {
  ...
  render() {
    return m`
      <main @click="${this.handleClick}">
        <mte-metrics-table .columns="${vo}" .currentPath="${this.path}" .model="${this.result}"> </mte-metrics-table>
...
nt([
  A()
], ye.prototype, "drawerMode", 2);
nt([
  A()
], ye.prototype, "result", 2);
nt([
  A({ attribute: !1, reflect: !1 })
], ye.prototype, "path", 2);
nt([
  A()
], ye.prototype, "selectedTest", 2);
ye = nt([
  B("mte-test-view")
], ye);
const vo = [
...
var gi = Object.defineProperty, bo = Object.getOwnPropertyDescriptor, yo = (e, t, r) => t in e ? gi(e, t, { enumerable: !0, configurable: !0, writable: !0, value: r }) : e[t] = r, it = (e, t, r, n) => {
  for (var i = n > 1 ? void 0 : n ? bo(t, r) : t, s = e.length - 1, a; s >= 0; s--)
    (a = e[s]) && (i = (n ? a(t, r, i) : a(i)) || i);
...
let we = class extends ae {
  ...
  render() {
    return m`${this.model ? m`<div class="overflow-x-auto rounded-md border border-gray-200">
  ...
  renderTableHeadRow() {
    ...
    return m`<thead class="border-b border-gray-200 text-center text-sm">
      <tr>
  ...
  renderTableHead(e) {
    const t = `tooltip-${e.key.toString()}`, r = e.tooltip ? m`<mte-tooltip title="${e.tooltip}" id="${t}">${e.label}</mte-tooltip>` : m`<span id="${t}">${e.label}</span>`;
    return e.group ? m` <th colspan="2" class="bg-gray-200 px-2"> ${r} </th>` : m`<th rowspan="2" class="w-24 px-2 even:bg-gray-100 2xl:w-28">
      <div class="inline-block">${r}</div>
    </th>`;
  }
  renderTableBody(e) {
    const t = () => e.file ? $ : e.childResults.map((r) => {
      const n = [r.name];
      for (; !r.file && r.childResults.length === 1; )
        r = r.childResults[0], n.push(r.name);
      return this.renderRow(n.join("/"), r, ...this.currentPath, ...n);
    });
    return m`<tbody class="divide-y divide-gray-200">${this.renderRow(e.name, e)} ${t()}</tbody>`;
  }
  renderRow(e, t, ...r) {
    return m`<tr title="${t.name}" class="group hover:bg-gray-200">
      <td class="font-semibold">
        <div class="flex items-center justify-start">
          <mte-file-icon file-name="${t.name}" ?file="${t.file}" class="mx-1"></mte-file-icon> ${r.length > 0 ? m`<a class="mr-auto inline-block w-full py-4 pr-2 hover:text-primary-on hover:underline" href="${xt(...r)}"
                >${e}</a
  ...
  renderCell(e, t) {
    const r = t[e.key], n = this.hasMultipleColspan ? "odd:bg-gray-100" : "even:bg-gray-100";
    if (e.category === "percentage") {
      const i = !isNaN(r), s = this.determineBgColoringClass(r), a = this.determineTextColoringClass(r), o = r.toFixed(2), l = `width: ${r}%`;
      return m`<td class="bg-gray-100 px-4 py-4 group-hover:bg-gray-200">
    ...
    return m`<td
      class="${fi({ "font-bold": e.isBold ?? !1, [n]: !0 })} py-4 text-center group-hover:bg-gray-200"
...
it([
  A()
], we.prototype, "model", 2);
it([
  A()
], we.prototype, "currentPath", 2);
it([
  A({ type: Array })
], we.prototype, "columns", 2);
it([
  A()
], we.prototype, "thresholds", 2);
we = it([
  B("mte-metrics-table")
], we);
const xo = '#report-code-block{background:var(--prism-background);border:1px solid var(--prism-border);overflow-x:auto;overflow-y:visible}.line-numbers{counter-reset:mte-line-number}.line .line-number{color:var(--mut-line-number);counter-increment:mte-line-number;padding:0 10px 0 15px;text-align:right}.line .line-number:before{content:counter(mte-line-number)}.line-marker:before{content:" ";padding:0 5px}svg.test-dot.Killing{fill:#15803d}svg.test-dot.Covering{fill:#fbbf24}svg.test-dot.NotCovering{fill:#f97316}svg.test-dot.selected{fill:#38bdf8}svg.test-dot{margin:2px}';
var mi = Object.defineProperty, $o = Object.getOwnPropertyDescriptor, ko = (e, t, r) => t in e ? mi(e, t, { enumerable: !0, configurable: !0, writable: !0, value: r }) : e[t] = r, $e = (e, t, r, n) => {
  for (var i = n > 1 ? void 0 : n ? $o(t, r) : t, s = e.length - 1, a; s >= 0; s--)
    (a = e[s]) && (i = (n ? a(t, r, i) : a(i)) || i);
  return n && i && mi(t, r, i), i;
}, _o = (e, t, r) => ko(e, t + "", r);
let ie = class extends ae {
  constructor() {
    super(), this.filters = [], this.lines = [], this.enabledStates = [], this.tests = [];
  }
  filtersChanged = (e) => {
  ...
  toggleTest(e) {
    this.selectedTest === e ? (this.selectedTest = void 0, this.dispatchEvent(re("test-selected", { selected: !1, test: e }))) : (this.selectedTest = e, this.dispatchEvent(re("test-selected", { selected: !0, test: e })), Qn(this.shadowRoot.querySelector(`[test-id="${e.id}"]`)));
  }
  nextTest = () => {
  ...
  renderTestList() {
    ...
    return e.length ? m`<ul class="max-w-6xl">
        ${We(
      e,
      (t) => t.id,
      (t) => m`<li class="my-3">
  ...
  renderCode() {
    if (this.model?.source) {
      ...
      const t = (r) => this.renderTestDots([...e.entries()].filter(([n]) => n > r).flatMap(([, n]) => n));
      return m`<pre id="report-code-block" class="line-numbers flex rounded-md p-1"><code class="flex language-${ur(
        this.model.name
      )}">
      <table>
        ${this.lines.map((r, n) => {
        const i = n + 1, s = this.renderTestDots(e.get(i)), a = this.lines.length === i ? t(i) : $;
        return ni(r, ri(s, a));
      })}</table></code></pre>`;
    }
    return $;
  ...
  renderTestDots(e) {
    return e?.length ? e.map(
      (t) => R`<svg test-id="${t.id}" class="cursor-pointer test-dot ${this.selectedTest === t ? "selected" : t.status}" @click=${(r) => {
        r.stopPropagation(), this.toggleTest(t);
      }} height="10" width="12">
          <title>${Ao(t)}</title>
          <circle cx="5" cy="5" r="5" />
  ...
  willUpdate(e) {
    e.has("model") && this.updateFileRepresentation(), (e.has("model") || e.has("enabledStates")) && this.model && (this.tests = this.model.tests.filter((t) => this.enabledStates.includes(t.status)).sort((t, r) => t.location && r.location ? gt(t.location.start, r.location.start) ? 1 : -1 : this.model.tests.indexOf(t) - this.model.tests.indexOf(r))), super.update(e);
  }
  updateFileRepresentation() {
    if (!this.model)
      return;
    const e = this.model;
    this.filters = [j.Killing, j.Covering, j.NotCovering].filter((t) => e.tests.some((r) => r.status === t)).map((t) => ({
      enabled: !0,
      count: e.tests.filter((r) => r.status === t).length,
      status: t,
      label: m`${Zt(t)} ${t}`,
      context: $a(t)
    })), this.model.source && (this.lines = Yt(Wt(this.model.source, this.model.name)));
  }
};
_o(ie, "styles", [bn, N, H(xo)]);
$e([
  A()
], ie.prototype, "model", 2);
$e([
  W()
], ie.prototype, "filters", 2);
$e([
  W()
], ie.prototype, "lines", 2);
$e([
  W()
], ie.prototype, "enabledStates", 2);
$e([
  W()
], ie.prototype, "selectedTest", 2);
$e([
  W()
], ie.prototype, "tests", 2);
ie = $e([
  B("mte-test-file")
], ie);
function Ao(e) {
...
var vi = Object.defineProperty, So = Object.getOwnPropertyDescriptor, Co = (e, t, r) => t in e ? vi(e, t, { enumerable: !0, configurable: !0, writable: !0, value: r }) : e[t] = r, pr = (e, t, r, n) => {
  for (var i = n > 1 ? void 0 : n ? So(t, r) : t, s = e.length - 1, a; s >= 0; s--)
    (a = e[s]) && (i = (n ? a(t, r, i) : a(i)) || i);
  return n && i && vi(t, r, i), i;
}, Eo = (e, t, r) => Co(e, t + "", r);
const Nt = (e) => m`<code>${e.getMutatedLines()}</code> (${Jn(e)})`;
let Je = class extends ae {
  ...
  renderSummary() {
    return Hn(
      m`${this.test?.killedMutants?.[0] ? pe(
        m`${E("🎯", "killed")} Killed:
            ${Nt(this.test.killedMutants?.[0])}${this.test.killedMutants.length > 1 ? m` (and ${this.test.killedMutants.length - 1} more)` : ""}`
      ) : $}
      ${Le(
        this.test?.coveredMutants,
        (e) => pe(
          m`${E("☂️", "umbrella")} Covered ${e.length}
          mutant${Gn(e)}${this.test?.status === j.Covering ? " (yet didn't kill any of them)" : ""}`
        )
      )}`
    );
  }
  renderDetail() {
    return m`<ul class="mb-12 mr-3">
      ...
      (e) => wt("This test killed this mutant", m`${E("🎯", "killed")} ${Nt(e)}`)
    )}
      ${this.test?.coveredMutants?.filter((e) => !this.test?.killedMutants?.includes(e)).map((e) => wt("This test covered this mutant", m`${E("☂️", "umbrella")} ${Nt(e)}`))}
    </ul>`;
  }
};
Eo(Je, "styles", [N]);
...
let Qe = class extends Z {
  ...
  get cssClass() {
    return fi({ [this.language?.toString() ?? "unknown"]: this.isFile, test: this.isTestFile });
  }
  render() {
    if (!this.isFile)
    ...
    if (!this.language)
      return R`<svg aria-label="file" class="octicon octicon-file" viewBox="0 0 12 16" version="1.1" width="12" height="16" role="img"><path fill-rule="evenodd" d="M6 5H2V4h4v1zM2 8h7V7H2v1zm0 2h7V9H2v1zm0 2h7v-1H2v1zm10-7.5V14c0 .55-.45 1-1 1H1c-.55 0-1-.45-1-1V2c0-.55.45-1 1-1h7.5L12 4.5zM11 5L8 2H1v12h10V5z"></path></svg>`;
    switch (this.language) {
      case K.csharp:
        return R`<svg class="${this.cssClass}" aria-label="cs" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32 32"><g><path d="M7.1 15.9c0-1.3.2-2.4.6-3.4.4-1 .9-1.8 1.6-2.5.7-.7 1.5-1.2 2.4-1.6s1.9-.5 2.9-.5 1.9.2 2.7.6c.8.4 1.5.9 2 1.4l-2.2 2.5c-.4-.3-.7-.6-1.1-.7-.4-.1-.8-.3-1.4-.3-.5 0-.9.1-1.3.3-.4.2-.8.5-1.1.9s-.5.8-.7 1.4c-.2.6-.3 1.2-.3 1.9 0 1.5.3 2.6 1 3.3.7.8 1.5 1.2 2.6 1.2.5 0 1-.1 1.4-.3.4-.2.8-.5 1.1-.9l2.2 2.5c-.7.8-1.4 1.3-2.2 1.7-.8.4-1.7.6-2.7.6s-2-.2-2.9-.5-1.7-.8-2.4-1.5-1.1-1.7-1.5-2.7c-.5-.9-.7-2.1-.7-3.4z"/><path d="M21.8 17.1h-1l-.4 2.4h-1.2l.4-2.4h-1.2V16h1.5l.2-1.6h-1.3v-1.1h1.5l.4-2.4h1.2l-.4 2.4h1l.4-2.4h1.2l-.4 2.4H25v1.1h-1.6l-.2 1.6h1.3v1.1h-1.6l-.4 2.4h-1.2c0 .1.5-2.4.5-2.4zm-.8-1h1l.2-1.6h-1l-.2 1.6z"/></g></svg>`;
      case K.html:
        return R`<svg class="${this.cssClass}" aria-label="html" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32 32"><path d="M8 15l6-5.6V12l-4.5 4 4.5 4v2.6L8 17v-2zm16 2.1l-6 5.6V20l4.6-4-4.6-4V9.3l6 5.6v2.2z"/></svg>`;
      case K.java:
        return R`<svg class="${this.cssClass}" aria-label="java" xmlns="http://www.w3.org/2000/svg" viewBox="-4 -4 20 20"><path class="cls-1" d="M6 0a6 6 0 1 0 6 6 6 6 0 0 0-6-6zm2.14 6.8a2.16 2.16 0 0 1-2.29 2.41 2.5 2.5 0 0 1-2-.87l.73-.92a1.52 1.52 0 0 0 1.23.59c.66 0 1.06-.42 1.06-1.32V2.8h1.26z"/></svg>`;
      case K.javascript:
      ...
      case K.vue:
        return R`<svg class="${this.cssClass}" aria-label="vue" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 1000"><path d="M600 495.9l159.1-275.4h-84.4L600 349.7l-74.6-129.2h-84.5z"/><path d="M793.7 220.5L600 555.9 406.3 220.5H277l323 559 323-559z"/></svg>`;
      case K.gherkin:
...
Fo(Qe, "styles", [H(Mo)]);
fr([
  A({ attribute: "file-name" })
], Qe.prototype, "fileName", 2);
fr([
  A({ attribute: "file", type: Boolean })
], Qe.prototype, "isFile", 2);
Qe = fr([
  B("mte-file-icon")
], Qe);
var yi = Object.defineProperty, zo = Object.getOwnPropertyDescriptor, Oo = (e, t, r) => t in e ? yi(e, t, { enumerable: !0, configurable: !0, writable: !0, value: r }) : e[t] = r, wi = (e, t, r, n) => {
  for (var i = n > 1 ? void 0 : n ? zo(t, r) : t, s = e.length - 1, a; s >= 0; s--)
    (a = e[s]) && (i = (n ? a(t, r, i) : a(i)) || i);
  return n && i && yi(t, r, i), i;
}, jo = (e, t, r) => Oo(e, t + "", r);
let At = class extends Z {
  render() {
    return m`<span class="cursor-help underline decoration-dotted" title="${this.title}"><slot></slot></span>`;
  }
};
jo(At, "styles", [N]);
wi([
...
var xi = Object.defineProperty, Ro = Object.getOwnPropertyDescriptor, $i = (e) => {
  throw TypeError(e);
}, Bo = (e, t, r) => t in e ? xi(e, t, { enumerable: !0, configurable: !0, writable: !0, value: r }) : e[t] = r, ke = (e, t, r, n) => {
  for (var i = n > 1 ? void 0 : n ? Ro(t, r) : t, s = e.length - 1, a; s >= 0; s--)
    (a = e[s]) && (i = (n ? a(t, r, i) : a(i)) || i);
  return n && i && xi(t, r, i), i;
}, Do = (e, t, r) => Bo(e, t + "", r), gr = (e, t, r) => t.has(e) || $i("Cannot " + r), Qr = (e, t, r) => (gr(e, t, "read from private field"), r ? r.call(e) : t.get(e)), Xr = (e, t, r) => t.has(e) ? $i("Cannot add the same private member more than once") : t instanceof WeakSet ? t.add(e) : t.set(e, r), Io = (e, t, r, n) => (gr(e, t, "write to private field"), t.set(e, r), r), X = (e, t, r) => (gr(e, t, "access private method"), r), De, V, ki, _i, Ai, Si, mr, vr, br;
let se = class extends Z {
  constructor() {
    super(), Xr(this, V), Xr(this, De), this.detected = 0, this.noCoverage = 0, this.pending = 0, this.survived = 0, this.total = 0, this.shouldBeSmall = !1;
  }
  connectedCallback() {
    super.connectedCallback(), Io(this, De, new window.IntersectionObserver(([e]) => {
      e.isIntersecting ? this.shouldBeSmall = !1 : this.shouldBeSmall = !0, this.requestUpdate();
    })), Qr(this, De).observe(this);
  }
  disconnectedCallback() {
    super.disconnectedCallback(), Qr(this, De)?.disconnect();
  }
  render() {
    return m`
      ${X(this, V, ki).call(this)}
      <div class="my-4 rounded-md border border-gray-200 bg-white transition-all">
        <div class="relative">
          <div class="parts flex h-8 w-full overflow-hidden rounded bg-gray-200">${X(this, V, Ai).call(this)}</div>
        </div>
      </div>
    `;
  }
  ...
  return m`<div
    ...
    >
      <div class="container w-full bg-white py-2">
        <div class="flex h-2 overflow-hidden rounded bg-gray-200">${X(this, V, mr).call(this).map((e) => X(this, V, _i).call(this, e))}</div>
      </div>
    </div>`;
};
_i = function(e) {
  return m`<div
      class="${X(this, V, vr).call(this, e.type)} z-20 h-2 transition-all"
      style="width: ${X(this, V, br).call(this, e.amount)}%"
    ></div>`;
};
Ai = function() {
  return m`${X(this, V, mr).call(this).map((e) => X(this, V, Si).call(this, e))}`;
};
Si = function(e) {
  return m`<div
      title="${e.tooltip}"
      style="width: ${X(this, V, br).call(this, e.amount)}%"
      class="${X(this, V, vr).call(this, e.type)} ${e.amount === 0 ? "opacity-0" : ""} relative flex h-8 items-center overflow-hidden transition-all"
    >
...
ke([
  A({ attribute: !1 })
], se.prototype, "detected", 2);
ke([
  A({ attribute: !1 })
], se.prototype, "noCoverage", 2);
ke([
  A({ attribute: !1 })
], se.prototype, "pending", 2);
ke([
  A({ attribute: !1 })
], se.prototype, "survived", 2);
ke([
  A({ attribute: !1 })
], se.prototype, "total", 2);
ke([
  W()
], se.prototype, "shouldBeSmall", 2);
se = ke([
  B("mte-result-status-bar")
], se);
export {
  L as MutationTestReportAppComponent
};
